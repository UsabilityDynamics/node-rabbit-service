...
function RabbitMQ() {
    ...
    if (_$jscoverage_done("lib/rabbitmq-client.js", 19, !(this instanceof RabbitMQ))) {
    ...
    _$jscoverage_done("lib/rabbitmq-client.js", 24);
    ...
    var self = this;
    _$jscoverage_done("lib/rabbitmq-client.js", 29);
    ...
    try {
        ...
        _$jscoverage_done("lib/rabbitmq-client.js", 41);
        self.set({
        ...
        _$jscoverage_done("lib/rabbitmq-client.js", 61);
        RabbitMQ.utility.each(self.get("settings.directories"), function(value, key) {
            _$jscoverage_done("lib/rabbitmq-client.js", 62);
        ...
        RabbitMQ.utility.each(self.get("settings.bin"), function(value, key) {
            _$jscoverage_done("lib/rabbitmq-client.js", 67);
        ...
        _$jscoverage_done("lib/rabbitmq-client.js", 74);
        if (_$jscoverage_done("lib/rabbitmq-client.js", 74, !self.get("validation").is_valid)) {
            _$jscoverage_done("lib/rabbitmq-client.js", 75);
            throw new Error("Validation Failure: " + validation.errors.join());
        }
        _$jscoverage_done("lib/rabbitmq-client.js", 79);
        ...
        _$jscoverage_done("lib/rabbitmq-client.js", 96);
        self.process.stdout.on("data", function(data) {
            _$jscoverage_done("lib/rabbitmq-client.js", 97);
            self.log("DATA:", data.toString());
        });
        _$jscoverage_done("lib/rabbitmq-client.js", 101);
        self.process.stderr.on("data", function(data) {
            _$jscoverage_done("lib/rabbitmq-client.js", 102);
            self.log("ERROR:", data.toString());
        });
        _$jscoverage_done("lib/rabbitmq-client.js", 106);
        self.set("process", RabbitMQ.utility.pick(self.process, "pid", "connected"));
        _$jscoverage_done("lib/rabbitmq-client.js", 109);
        RabbitMQ._instance[self.get("settings.name")] = self;
    } catch (error) {
        _$jscoverage_done("lib/rabbitmq-client.js", 112);
        console.error(error.message);
        _$jscoverage_done("lib/rabbitmq-client.js", 113);
        return self;
    }
    _$jscoverage_done("lib/rabbitmq-client.js", 117);
    return self;
}

_$jscoverage_done("lib/rabbitmq-client.js", 125);
Object.defineProperties(RabbitMQ.prototype, {
    log: {
        value: function log() {
            _$jscoverage_done("lib/rabbitmq-client.js", 135);
            return console.log.apply(console, arguments);
            _$jscoverage_done("lib/rabbitmq-client.js", 136);
...
_$jscoverage_done("lib/rabbitmq-client.js", 240);
Object.defineProperties(module.exports = RabbitMQ, {
    create: {
        value: function create(settings, callback) {
            _$jscoverage_done("lib/rabbitmq-client.js", 249);
    ...
    destroy: {
        value: function destroy(pid) {
            _$jscoverage_done("lib/rabbitmq-client.js", 271);
    ...
    startService: {
        value: function startService(settings, callback) {
            _$jscoverage_done("lib/rabbitmq-client.js", 292);
    ...
    createClient: {
        value: function createClient(settings, callback) {
            _$jscoverage_done("lib/rabbitmq-client.js", 304);
            console.log("asdf");
        },
        enumerable: true
    },
    getInstance: {
        value: function getInstance(pid) {
            _$jscoverage_done("lib/rabbitmq-client.js", 316);
