...
_$jscoverage_init(_$jscoverage, "lib/rabbitmq-service.js",[20,23,24,27,28,29,30,33,35,38,41,42,45,52,65,66,70,71,75,78,79,83,86,101,103,104,108,109,113,114,117,118,122,125,126,130,138,148,149,162,163,257,267,276,298,319,331,343]);
_$jscoverage_init(_$jscoverage_cond, "lib/rabbitmq-service.js",[23,78]);
...
function RabbitMQ() {
    ...
    if (_$jscoverage_done("lib/rabbitmq-service.js", 23, !(this instanceof RabbitMQ))) {
        _$jscoverage_done("lib/rabbitmq-service.js", 24);
        return new RabbitMQ(arguments[0], arguments[1]);
    }
    _$jscoverage_done("lib/rabbitmq-service.js", 27);
    var path = require("path");
    _$jscoverage_done("lib/rabbitmq-service.js", 28);
    ...
    _$jscoverage_done("lib/rabbitmq-service.js", 30);
    var self = this;
    _$jscoverage_done("lib/rabbitmq-service.js", 33);
    RabbitMQ.utility.inherits(callback, RabbitMQ);
    _$jscoverage_done("lib/rabbitmq-service.js", 35);
    try {
        ...
        _$jscoverage_done("lib/rabbitmq-service.js", 42);
        RabbitMQ.utility.settings.mixin(self);
        _$jscoverage_done("lib/rabbitmq-service.js", 45);
        self.set({
        ...
        _$jscoverage_done("lib/rabbitmq-service.js", 52);
        self.set({
        ...
        _$jscoverage_done("lib/rabbitmq-service.js", 65);
        ...
        _$jscoverage_done("lib/rabbitmq-service.js", 70);
        ...
        _$jscoverage_done("lib/rabbitmq-service.js", 78);
        if (_$jscoverage_done("lib/rabbitmq-service.js", 78, !self.get("validation").is_valid)) {
            _$jscoverage_done("lib/rabbitmq-service.js", 79);
            throw new Error("Validation Failure: " + validation.errors.join());
        }
        _$jscoverage_done("lib/rabbitmq-service.js", 83);
        self = new callback(null, self);
        _$jscoverage_done("lib/rabbitmq-service.js", 86);
        ...
        _$jscoverage_done("lib/rabbitmq-service.js", 101);
        self.set("process", RabbitMQ.utility.pick(self.process, "pid", "connected"));
        _$jscoverage_done("lib/rabbitmq-service.js", 103);
        self.process.on("exit", function() {
            _$jscoverage_done("lib/rabbitmq-service.js", 104);
            self.emit("service.exit", arguments);
        });
        _$jscoverage_done("lib/rabbitmq-service.js", 108);
        self.process.stdout.on("data", function(data) {
            _$jscoverage_done("lib/rabbitmq-service.js", 109);
        ...
        _$jscoverage_done("lib/rabbitmq-service.js", 117);
        process.nextTick(function() {
            _$jscoverage_done("lib/rabbitmq-service.js", 118);
            self.emit("service.starting");
        });
        _$jscoverage_done("lib/rabbitmq-service.js", 122);
        RabbitMQ._instance[self.get("settings.name")] = self;
    } catch (error) {
        _$jscoverage_done("lib/rabbitmq-service.js", 125);
        console.error(error.message);
        _$jscoverage_done("lib/rabbitmq-service.js", 126);
        return self;
    }
    _$jscoverage_done("lib/rabbitmq-service.js", 130);
    return self;
}

_$jscoverage_done("lib/rabbitmq-service.js", 138);
Object.defineProperties(RabbitMQ.prototype, {
    stop: {
        value: function log() {
            _$jscoverage_done("lib/rabbitmq-service.js", 148);
            this.debug("Stopping Service [%s].", this.get("process.pid"));
            _$jscoverage_done("lib/rabbitmq-service.js", 149);
    ...
    log: {
        value: function log() {
            _$jscoverage_done("lib/rabbitmq-service.js", 162);
            return console.log.apply(console, arguments);
            _$jscoverage_done("lib/rabbitmq-service.js", 163);
    ...
    configure: {
        value: function configure(callback) {
            _$jscoverage_done("lib/rabbitmq-service.js", 257);
...
_$jscoverage_done("lib/rabbitmq-service.js", 267);
Object.defineProperties(module.exports = RabbitMQ, {
    create: {
        value: function create(settings, callback) {
            _$jscoverage_done("lib/rabbitmq-service.js", 276);
    ...
    destroy: {
        value: function destroy(pid) {
            _$jscoverage_done("lib/rabbitmq-service.js", 298);
    ...
    startService: {
        get: function startService() {
            _$jscoverage_done("lib/rabbitmq-service.js", 319);
    ...
    createClient: {
        value: function createClient(settings, callback) {
            _$jscoverage_done("lib/rabbitmq-service.js", 331);
            console.log("asdf");
        },
        enumerable: true
    },
    getInstance: {
        value: function getInstance(pid) {
            _$jscoverage_done("lib/rabbitmq-service.js", 343);
