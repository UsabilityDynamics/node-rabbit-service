...
_$jscoverage_init(_$jscoverage, "lib/rabbitmq-service.js",[16,19,20,23,24,25,26,29,31,34,37,38,41,48,61,62,66,67,71,74,75,79,82,96,97,101,102,106,109,112,113,117,125,135,136,230,240,249,271,292,304,316]);
...
function RabbitMQ() {
    ...
    try {
        ...
        _$jscoverage_done("lib/rabbitmq-service.js", 96);
        ...
        _$jscoverage_done("lib/rabbitmq-service.js", 106);
        ...
        _$jscoverage_done("lib/rabbitmq-service.js", 112);
...
Object.defineProperties(RabbitMQ.prototype, {
    log: {
        value: function log() {
            _$jscoverage_done("lib/rabbitmq-service.js", 135);
    ...
    configure: {
        value: function configure(callback) {
            _$jscoverage_done("lib/rabbitmq-service.js", 230);
...
_$jscoverage_done("lib/rabbitmq-service.js", 240);
Object.defineProperties(module.exports = RabbitMQ, {
    create: {
        value: function create(settings, callback) {
            _$jscoverage_done("lib/rabbitmq-service.js", 249);
    ...
    destroy: {
        value: function destroy(pid) {
            _$jscoverage_done("lib/rabbitmq-service.js", 271);
    ...
    startService: {
        get: function startService() {
            _$jscoverage_done("lib/rabbitmq-service.js", 292);
    ...
    createClient: {
        value: function createClient(settings, callback) {
            _$jscoverage_done("lib/rabbitmq-service.js", 304);
            console.log("asdf");
        },
        enumerable: true
    },
    getInstance: {
        value: function getInstance(pid) {
            _$jscoverage_done("lib/rabbitmq-service.js", 316);
